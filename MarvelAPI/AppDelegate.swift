...
//        apiClient.requestSignalProducer(ComicAPIRequest(comicId: 61537)).observe(on: UIScheduler()).on(event: { event in
//            print("Event: \(String(describing: event.value?.results.first))")
//        }, failed: { error in
//            print("Error: \(error)")
//        }, completed: {
//            print("Completed")
